...
/* ---------------------------------------------------------------------- */
/*	Facts and figure scrollTop
/* ---------------------------------------------------------------------- */
var scrollfact = $(window).scrollTop();

$(window).scroll(function(){

	if(scrollfact > 1150){
		$(".fact_figure_bg").animate({'background-position-y': "-100px"}, 'slow');

	}else if(scrollfact < 800){
		$(".fact_figure_bg").animate({'background-position-y': "50px"}, 'slow');
	}
